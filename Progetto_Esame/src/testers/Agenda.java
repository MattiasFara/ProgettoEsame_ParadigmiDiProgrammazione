...
public class Agenda implements Iterable<Appuntamento> {
	 ...
	 * <p> Inizializza una agenda di tipo ArrayList<Appuntamento> vuota;
	 */
	public Agenda() {
	 ...
	 * @throws OverlapException se l'appuntamento si sovrappone con un altro appuntamento della lista
	 */
	// public invece di private
	public void checkOverlapList(Appuntamento a, int i) throws OverlapException {
		int counter = 0;
		for(Appuntamento e: agenda) {
	 ...
	 */
	// public invece di private
	public void checkOverlap(Appuntamento a, Appuntamento b) throws OverlapException {
	 ...
	 */
	public <T> ArrayList<Appuntamento> search(ArrayList<Appuntamento> list, T s, Search<T> searchCriteria) {
		ArrayList<Appuntamento> results = new ArrayList<Appuntamento>();
		for(Appuntamento a: list) {
			if(searchCriteria.searchMethod(s, a)) {
				results.add(a);
			}
		}
		return results;
